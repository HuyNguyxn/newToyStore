...
public class ImportNote extends BaseRootEntity {
    ...
    public ImportNote(Integer supplierId, String note) {
        if (supplierId == null) throw new IllegalArgumentException("Mã nhà cung cấp không được để trống");
    ...
    @Override public boolean equals(Object o) { return this == o || (o instanceof ImportNote u && id != null && id.equals(u.id)); }
