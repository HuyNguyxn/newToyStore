...
public class SecurityConfig {
    ...
    private List<String> resolveAllowedOrigins() {
        ...
        String normalizedFrontendUrl = normalizeOrigin(frontendBaseUrl);
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/imports/**", "/warehouse/**", "/inventory/**")
                        ...
                        .requestMatchers("/reviews/admin/**").hasAnyRole("STAFF", "MANAGER", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/reviews/products/**").permitAll()
                        .requestMatchers("/reviews/**").hasAnyRole("CUSTOMER", "STAFF", "MANAGER", "ADMIN")
