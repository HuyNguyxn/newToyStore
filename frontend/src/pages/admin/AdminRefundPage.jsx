  ...
  return (
    <section style={{ padding: '24px', background: '#f8fafc', minHeight: '100vh', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      >
        ...
        >
          {loading ? 'Đang tải...' : 'Tìm yêu cầu hoàn tiền'}
        </button>
      </form>
                  ...
                  >
                    ...
                    <td style={{ padding: '14px 16px', textAlign: 'center' }}>
                      <div style={{ display: 'inline-flex', gap: '6px', justifyContent: 'center' }}>
                        <button
                          type="button"
                          onClick={() => handleAction(() => processPaymentRefund(refund.id))}
                          style={{
                            padding: '6px 12px',
                            background: '#ffffff',
                            color: '#16a34a',
                        ...
                        <button
                          type="button"
                          onClick={() => handleAction(() => rejectPaymentRefund(refund.id, rejectReason))}
                          style={{
                            padding: '6px 12px',
                            background: '#ffffff',
                            color: '#dc2626',
                        ...
                        {canDelete && (
                          <button
                            type="button"
                            onClick={() => handleAction(() => deletePaymentRefund(refund.id))}
                            style={{
                              padding: '6px 12px',
                              background: '#ffffff',
                              color: '#64748b',
